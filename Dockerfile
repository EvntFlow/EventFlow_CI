# Generated by EventFlow CI on Tue Apr 15 03:04:22 UTC 2025.
# DO NOT EDIT.
...
# Download archive
RUN curl -SL https://github.com/EvntFlow/EventFlow_CI/releases/latest/download/eventflow.tar.gz | tar -xzf -
